...
public class NotificationManager {
    ...
    public static class Notification {
        ...
        private transient IText cachedText;
        ...
        private void updateCachedText () {
            this.cachedText = new IText(this.getComponent());
        ...
        private void render (DrawContext graphics, Coordinate preInfo, Coordinate screenInfo, long currentTime) {
         ...
         * @param coordinate 当前通知的布局信息
         */
        private void doRender(DrawContext graphics, Coordinate coordinate) {
    ...
    public void render(DrawContext graphics) {
        ...
        Coordinate screenInfo = new Coordinate()
                .setWidth(mc.getWindow().getScaledWidth())
                .setHeight(mc.getWindow().getScaledHeight());
