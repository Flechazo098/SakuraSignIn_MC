...
public class I18nUtils {
    ...
    private static final String DEFAULT_LANGUAGE = SakuraSignInFabric.DEFAULT_LANGUAGE;
    private static final Gson GSON = new Gson();
    private static final Logger LOGGER = LogManager.getLogger();
    private static final String LANG_PATH = String.format("/assets/%s/lang/", SakuraSignInFabric.MOD_ID);
    ...
    public static String getKey(EI18nType type, String key) {
        ...
        if (type == EI18nType.PLAIN || type == EI18nType.NONE) {
            ...
            result = String.format("%s.%s.%s", type.name().toLowerCase(), SakuraSignInFabric.MOD_ID, key);
        }
        return result;
    }
