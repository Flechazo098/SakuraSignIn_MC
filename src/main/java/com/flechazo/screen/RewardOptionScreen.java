...
import com.flechazo.config.RewardOptionData;
...
import com.flechazo.screen.component.*;
...
public class RewardOptionScreen extends Screen {
    ...
    private StringInputScreen getRuleKeyInputScreen(Screen callbackScreen, ERewardRule rule, String[] key) {
        ...
        return new StringInputScreen(callbackScreen, IText.i18n("请输入规则名称").setShadow(true), IText.i18n("请输入"), validator, "", input -> {
    ...
    private StringInputScreen getCdkRuleKeyInputScreen(Screen callbackScreen, ERewardRule rule, String[] key) {
        return new StringInputScreen(callbackScreen
                , new TextList (IText.i18n("请输入规则名称").setShadow(true), IText.i18n("请输入有效期").setShadow(true))
                , new TextList(IText.i18n("请输入"))
                , new StringList("\\w*", "")
    ...
    private void handleOperation(double mouseX, double mouseY, int button, OperationButton value, AtomicBoolean updateLayout, AtomicBoolean flag) {
        ...
        // 左侧边栏奖励规则类型按钮
            ...
            if (button == GLFW.GLFW_MOUSE_BUTTON_LEFT) {
                ...
                this.popupOption.addOption(IText.i18n("清空").setColor(0xFFFF0000))
                        .addTips(IText.i18n("Ctrl + 鼠标右键确认"))
        ...
        // 奖励配置列表面板
            ...
            if (button == GLFW.GLFW_MOUSE_BUTTON_RIGHT) {
                if (this.currOpButton > 200 && this.currOpButton <= 299) {
                    this.popupOption.clear();
                    this.popupOption.addOption(IText.i18n("粘贴"));
                    for (ERewardType rewardType : ERewardType.values()) {
                        this.popupOption.addOption(IText.translatable(String.format("reward.sakura_sign_in.reward_type_%s", rewardType.getCode())));
                    }
        ...
        // 帮助按钮
            ...
            // 绘制弹出层提示
            this.popupOption.clear();
            this.popupOption.addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_1"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_2"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_3"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_4"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_5"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_6"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_7"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_8"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_9"))
                    .addOption(IText.translatable("tips.sakura_sign_in.reward_rule_description_10"))
        ...
        if (button == GLFW.GLFW_MOUSE_BUTTON_RIGHT) {
            if (key.startsWith("标题")) {
                ...
                if (!"标题,base".equalsIgnoreCase(key)) {
                    this.popupOption.addOption(IText.i18n("编辑"));
                }
                this.popupOption.addOption(IText.i18n("复制"));
                if (!"标题,base".equalsIgnoreCase(key)) {
                    this.popupOption.addOption(IText.i18n("剪切"));
                }
                this.popupOption.addOption(IText.i18n("粘贴"));
                for (ERewardType rewardType : ERewardType.values()) {
                    this.popupOption.addOption(IText.translatable(String.format("reward.sakura_sign_in.reward_type_%s", rewardType.getCode())));
                ...
                this.popupOption.addOption(IText.i18n("清空").setColor(0xFFFF0000));
                if (!"标题,base".equalsIgnoreCase(key)) {
                    this.popupOption.addOption(IText.i18n("删除").setColor(0xFFFF0000));
                }
                this.popupOption.addTips(IText.i18n("Ctrl + 鼠标右键确认"), -1)
                        .addTips(IText.i18n("Ctrl + 鼠标右键确认"), -2)
                        .setTipsKeyCode(GLFW.GLFW_KEY_LEFT_SHIFT)
                        .setTipsModifiers(GLFW.GLFW_MOD_SHIFT)
                ...
                this.popupOption.clear();
                this.popupOption.addOption(IText.i18n("编辑"))
                        .addOption(IText.i18n("复制"))
                        .addOption(IText.i18n("剪切"))
                        .addOption(IText.i18n("粘贴"))
                        .addOption(IText.i18n("删除").setColor(0xFFFF0000))
                        .addTips(IText.i18n("Ctrl + 鼠标右键确认"), -1)
                        .setTipsKeyCode(GLFW.GLFW_KEY_LEFT_SHIFT)
                        .setTipsModifiers(GLFW.GLFW_MOD_SHIFT)
                        .build(super.textRenderer, mouseX, mouseY, String.format("奖励按钮:%s", key));
            }
        ...
        if (popupOption.getId().startsWith("奖励规则类型按钮:")) {
            ...
            // 经验点
                ...
                StringInputScreen callbackScreen = new StringInputScreen(this
                        , new TextList(IText.i18n("请输入经验点值").setShadow(true), IText.i18n("请输入奖励概率").setShadow(true))
                        , new TextList(IText.i18n("请输入"))
            ...
            // 经验等级
                ...
                StringInputScreen callbackScreen = new StringInputScreen(this
                        , new TextList(IText.i18n("请输入经验等级").setShadow(true), IText.i18n("请输入奖励概率").setShadow(true))
                        , new TextList(IText.i18n("请输入"))
                        , new StringList("-?\\d*", "(0?1(\\.0{0,5})?|0(\\.\\d{0,5})?)?")
                        , new StringList("1")
                        , input -> {
            ...
            // 补签卡
                ...
                StringInputScreen callbackScreen = new StringInputScreen(this
                        , new TextList(IText.i18n("请输入补签卡数量").setShadow(true), IText.i18n("请输入奖励概率").setShadow(true))
                        , new TextList(IText.i18n("请输入"))
                        , new StringList("-?\\d*", "(0?1(\\.0{0,5})?|0(\\.\\d{0,5})?)?")
                        , new StringList("1")
                        , input -> {
            ...
            // 消息
                ...
                StringInputScreen callbackScreen = new StringInputScreen(this
                        , new TextList(IText.i18n("请输入消息").setShadow(true), IText.i18n("请输入奖励概率").setShadow(true))
                        , new TextList(IText.i18n("请输入"))
                        , new StringList("", "(0?1(\\.0{0,5})?|0(\\.\\d{0,5})?)?")
                        , new StringList("", "1")
                        , input -> {
                    if (CollectionUtils.isNotNullOrEmpty(input) && StringUtils.isNotNullOrEmpty(key[0])) {
                        MutableText textToComponent = AbstractGuiUtils.textToComponent(IText.literal(input.get(0)));
                        BigDecimal p = StringUtils.toBigDecimal(input.get(1), BigDecimal.ONE);
            ...
            // 指令
                ...
                StringInputScreen callbackScreen = new StringInputScreen(this
                        , new TextList(IText.i18n("请输入指令").setShadow(true), IText.i18n("请输入奖励概率").setShadow(true))
                        , new TextList(IText.i18n("请输入"))
                        , new StringList("", "(0?1(\\.0{0,5})?|0(\\.\\d{0,5})?)?")
                        , new StringList("", "1")
                        , input -> {
                    ...
                    if (button == GLFW.GLFW_MOUSE_BUTTON_LEFT) {
                        ...
                        // 消息
                            ...
                            MinecraftClient.getInstance().setScreen(new StringInputScreen(this
                                    ...
                                    , new TextList(IText.i18n("请输入"))
                                    , new StringList("", "(0?1(\\.0{0,5})?|0(\\.\\d{0,5})?)?")
                                    , new StringList(((MutableText) RewardManager.deserializeReward(reward)).getString(), StringUtils.toFixedEx(reward.getProbability(), 5))
                                    , input -> {
                                if (CollectionUtils.isNotNullOrEmpty(input)) {
                                    MutableText textToComponent = AbstractGuiUtils.textToComponent(IText.literal(input.get(0)));
                                    BigDecimal p = StringUtils.toBigDecimal(input.get(1), BigDecimal.ONE);
    ...
    private Consumer<OperationButton.RenderContext> generateCustomRenderFunction(String content) {
        return context -> {
            ...
            AbstractGuiUtils.drawLimitedText(context.graphics(), super.textRenderer, getByZh(content), realX + 4, (int) (realY + (realHeight - super.textRenderer.fontHeight) / 2), (int) (realWidth - 22), 0xFFEBD4B1);
        };
    }
    ...
    public RewardOptionScreen() {
        super(Text.translatable("screen.sakura_sign_in.reward_option_title"));
    }
    ...
    public void render(DrawContext graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (SakuraSignInFabric.isRewardOptionBarOpened()) {
            graphics.drawCenteredTextWithShadow(super.textRenderer, getByZh("奖励规则类型"), 4, 5, 0xFFACACAC);
            ...
            // 绘制其他按钮
                ...
                // 帮助按钮
                    ...
                    if (player != null && player.hasPermissionLevel(3)) {
                        ...
                        button.setTooltip(IText.i18n("将配置文件同步至服务器\n权限不足").setColor(0xFFFF0000))
                                .setHoverFgColor(0xAA808080).setTapFgColor(0xAA808080);
                    }
                }
                button.renderPopup(graphics, mouseX, mouseY, this.keyCode, this.modifiers);
